...
interface ColorHeaderSectionProps {
    onOpenModal: () => void;
    filter: 'all' | 'active' | 'inactive';
    onFilterChange: (filter: 'all' | 'active' | 'inactive') => void;
}

export default function ColorHeaderSection({ onOpenModal, filter, onFilterChange }: ColorHeaderSectionProps) {
    return (
        <div className="mb-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-sm">
                            Administra los colores disponibles para los productos
                        </p>
                    </div>
                </div>
